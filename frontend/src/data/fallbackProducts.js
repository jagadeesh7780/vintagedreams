...
const buildCatalog = () => {
  ...
  const curatedShowroomItems = [
    ...
    {
      _id: 'prod_vintage_1950s_polka_dress',
    ...
    {
      _id: 'prod_vintage_1960s_camel_coat',
    ...
    {
      _id: 'prod_vintage_1970s_boho_dress',
    ...
    {
      _id: 'prod_vintage_1920s_tweed_suit',
    ...
    {
      _id: 'prod_vintage_saddle_leather_satchel',
    ...
    {
      _id: 'prod_vintage_cognac_crossbody',
    ...
    {
      _id: 'prod_vintage_victorian_boots',
    ...
    {
      _id: 'prod_vintage_cloche_felt_hat',
    ...
    {
      _id: 'prod_vintage_emerald_pearl_brooch',
    ...
    {
      _id: 'prod_vintage_silk_brocade_scarf',
    ...
    {
      _id: 'prod_vintage_handknit_wool_shawl',
  ...
  // 12. Vintage Heritage & 1990s Archive Collection (Unisex / Both)
